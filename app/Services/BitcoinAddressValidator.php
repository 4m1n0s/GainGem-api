...
class BitcoinAddressValidator
{
     ...
     * @return false|string
     */
    public static function typeOf(string $addr)
    {
    ...
    public static function isValid(string $addr): bool
    {
        ...
        return in_array($type, [self::MAINNET_PUBKEY, self::MAINNET_SCRIPT]);
    }

    protected static function decodeAddress(string $data): string
    {
